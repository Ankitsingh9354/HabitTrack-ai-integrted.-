...
Suggest 3 personalised habits now. Return JSON only.`;
    ...
    try {
      ...
      suggestions = [
        ...
        {
          name: "Daily Reading",
          description: "Read 10 pages of a book every day.",
          frequency: "daily",
          category: "Learning",
          icon: "📚",
          reason: "Builds knowledge and improves focus over time.",
        },
        {
          name: "Evening Reflection",
          description: "Write down three things you achieved today.",
          frequency: "daily",
          category: "Mindfulness",
          icon: "📝",
          reason: "Helps reinforce progress and maintain motivation.",
        },
      ];
    }
...
export const recoveryPlan = async (req, res) => {
  try {
    ...
    const userMsg = `Habit: ${habit.name} (${habit.category}).\nDescription: ${habit.description || "not provided"}\nCurrent streak: ${current} days, Longest streak: ${longest} days.\n\nGenerate a tailored recovery strategy to help the user get back on track.`;
